...
/**
  ...
  * @retval None 	
  */ 
void Remote_Convert(rc_ctrl_t RcCtrl)
{
	if(RcCtrl.rc.s2 == 1)//键鼠模式
	{
//		Status.Rc_States = State0;
	}
	else if(RcCtrl.rc.s2 == 3)//摇杆模式
	{
//		Status.Rc_States = State1;
	}
	else if(RcCtrl.rc.s2 == 2)//掉电模式
	{
//		Status.Rc_States = State2;
	}
	else
	{
//		Status.Rc_States = State2;
